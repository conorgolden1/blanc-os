...
pub static FRAME_ALLOCATOR : Once<Mutex<PhysFrameAllocator>> = Once::new();
...
impl PhysFrameAllocator {
    ...
    pub unsafe fn init(memory_regions: &'static MemoryRegions, page_table : &mut RecursivePageTable) {
        ...
        let frame_allocator = PhysFrameAllocator {
